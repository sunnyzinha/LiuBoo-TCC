...
// Imagens para o quiz
const images = {
  pineapple: require('../assets/abacaxi.png'),
  apple: require('../assets/maca.png'),
  strawberry: require('../assets/morango.png'),
  pear: require('../assets/pera.png'),
  watermelon: require('../assets/melancia.png'),
  orange: require('../assets/laranja.png'),
...
    question: 'WHAT IS ABACAXI?',
    options: [
      { name: 'pineapple', image: images.pineapple, isCorrect: true },
      { name: 'apple', image: images.apple, isCorrect: false },
      { name: 'strawberry', image: images.strawberry, isCorrect: false },
      { name: 'pear', image: images.pear, isCorrect: false },
    ],
  },
  {
    type: 'textInput',
...
  {
    type: 'multipleChoiceImage',
    question: 'WHAT IS MAÇA?',
    options: [
      { name: 'pear', image: images.pear, isCorrect: false },
      { name: 'watermelon', image: images.watermelon, isCorrect: false },
      { name: 'apple', image: images.apple, isCorrect: true },
      { name: 'orange', image: images.orange, isCorrect: false },
    ],
  },
  {
    type: 'textInput',
...
  {
    type: 'multipleChoiceImage',
    question: 'WHAT IS MORANGO?',
    options: [
      { name: 'pineapple', image: images.pineapple, isCorrect: false },
      { name: 'strawberry', image: images.strawberry, isCorrect: true },
      { name: 'pear', image: images.pear, isCorrect: false },
      { name: 'orange', image: images.orange, isCorrect: false },
    ],
  },
...
    if (currentQuestionIndex >= questions.length - 1 && wrongAnswers.length === 0 && isCorrect) {
      // Finalizou o quiz → só fecha modal
      setShowModal(false);
...
            ]}
            placeholder="Type the name of fruit"
            value={userInput}
...
          <Text style={styles.progressText}>{correctlyAnsweredCount}/{quizData.length}</Text>
        </View>
...
        {/* Modal de feedback com o novo design */}
...
    fontWeight: 'bold',
  },
  // Novas propriedades de estilo para o modal
  modalOverlay: {
    flex: 1,
